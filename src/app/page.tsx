    ...
    return (
        <main className="flex min-h-screen flex-col text-white ">
            <div className="container mx-auto flex flex-col w-full lg:w-3/5 text-center gap-12 px-4 py-24 mt-14">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold balance">Find <span
                    className="bg-transparent font-extrabold text-white shadow-[inset_0_-0.5em_0_0_rgb(253_22_20_/_70%)]">thumbnails</span> for
                    YouTube videos</h1>
                <h2 className="text-md md:text-lg lg:text-xl lg:w-3/4 lg:m-auto">Explore a
                    user-friendly
                    platform to
                    view
                    full-size
                    thumbnail alongside the
            ...
            <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
                {[image1, image2, image3, image4, image5].sort(() => Math.random() - 0.5).map((image, imageIndex) => (
                    <div
                        key={image.src}
                        className={clsx(
                    ...
                    >
                        <Image alt="Thumbnail" src={image} placeholder="blur"
                               sizes="(min-width: 640px) 1rem, 11rem"
